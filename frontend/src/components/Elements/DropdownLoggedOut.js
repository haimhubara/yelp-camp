...
export const DropdownLoggedOut = ({setDropDown}) => {
  return (
    <div id="dropdownAvatar" className="select-none	absolute top-10 left-0 z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
