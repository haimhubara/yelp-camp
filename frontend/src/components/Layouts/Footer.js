  ...
  return (
    <footer className="bg-white shadow dark:bg-gray-800 dark:border dark:border-gray-700">
        <div className="p-4 mx-auto max-w-screen-xl md:flex md:items-center md:justify-between md:p-6">            
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <Link to="/campgrounds" className="hover:underline">YelpCamp</Link>. All Rights Reserved.</span>
